...
int ShaderYUV::createProgram() {
    ...
    vertex_shader_graphical = ShaderUtils::openAssetsFile(this->context->assetManager, "vertex_display.glsl");
    fragment_shader_graphical = ShaderUtils::openAssetsFile(this->context->assetManager, "fragment_display.glsl");
    GLuint mProgram;
